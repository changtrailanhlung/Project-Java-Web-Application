<%-- 
    Document   : PostDetail
    Created on : Nov 2, 2019, 12:11:14 PM
    Author     : lehon
--%>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="CreateNewPost.jsp">Home</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="CreatePost.html">Create Blog</a></li>
                        ...
                        if (session.getAttribute("listPost") != null) {
                            ...
                            if (listPost.size() > 0) {
                                ...
                                for (BlogPostDTO elem : listPost) {
                                    ...
                                    if (elem.getID() == Integer.parseInt(request.getParameter("txtID"))) {
...
<!--                                            <div class="badge badge-primary text-wrap" >
                                    ...
                                    <!--<h4>-->
<!--                                        <div class="col-md-6 text-center">Author: <%= author%></div>
                                        <div class="col-md-6 text-center">Topic: <%= topic%></div>
                                        <div class="col-md-6 text-center">Create Date: <%= create%></div>
                                        <div class="col-md-6 text-center">Update Date: <%= update%></div>
                                    </h4>
                                    <div class="text-nowrap bd-highlight"><p><%= detail%></p></div>-->
                                        <b>Author: <i><%= author %></i></b>
                                            <div class="col-2 text-truncate">
                                                <%= detail %></div>
                                                <p> <b>Topic: </b> <i><%= topic %></i> </p>
                    ...
                    <%
                        ...
                        if (count == 0) {
                    %>
                    <h1>THIS BLOG HAS BEEN REMOVED</h1>
                    <%
                                }
                            }
                        }
